...
**核心洞察**：能量-几何解耦能避免模型在过拟合吸引盆中的无效游走，直接穿越高维峡谷抵达泛化解。ARS2D (A-GSAM) 在 60 轮达成顿悟、112 轮收敛，是所有变体中最快的。Muon 和 AdamW 在 600 轮内未能实现顿悟。
